require=function(r,e,n){function t(n,o){function i(r){return t(i.resolve(r))}function f(e){return r[n][1][e]||e}if(!e[n]){if(!r[n]){var c="function"==typeof require&&require;if(!o&&c)return c(n,!0);if(u)return u(n,!0);var l=new Error("Cannot find module '"+n+"'");throw l.code="MODULE_NOT_FOUND",l}i.resolve=f;var s=e[n]=new t.Module(n);r[n][0].call(s.exports,i,s,s.exports)}return e[n].exports}function o(r){this.id=r,this.bundle=t,this.exports={}}var u="function"==typeof require&&require;t.isParcelRequire=!0,t.Module=o,t.modules=r,t.cache=e,t.parent=u;for(var i=0;i<n.length;i++)t(n[i]);return t}({31:[function(require,module,exports) {
'use strict';
...
var HeadlessComponents = function (_radi$Component) {
  _inherits(HeadlessComponents, _radi$Component);

  function HeadlessComponents() {
    var _ref;

    _classCallCheck(this, HeadlessComponents);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    var _this = _possibleConstructorReturn(this, (_ref = HeadlessComponents.__proto__ || Object.getPrototypeOf(HeadlessComponents)).call.apply(_ref, [this].concat(args)));
  ...
  _createClass(HeadlessComponents, [{
    key: 'view',
    value: function view() {
      var component = this;
      return [_radi3.default.r(
        ...
        null,
        _radi3.default.r('div', { 'class': 'wrapper main markdown-body', html: _docsBundle2.default.headlessComponents })
      )];
    }
  }]);
