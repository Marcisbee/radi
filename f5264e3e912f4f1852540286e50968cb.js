...
var Listener = function (_radi$Component) {
  _inherits(Listener, _radi$Component);
  ...
  function Listener() {
    ...
    var _this = _possibleConstructorReturn(this, (_ref = Listener.__proto__ || Object.getPrototypeOf(Listener)).call.apply(_ref, [this].concat(args)));
  ...
  _createClass(Listener, [{
    ...
    value: function view() {
      ...
      return [_radi3.default.r(
        ...
        null,
        _radi3.default.r('div', { 'class': 'wrapper main markdown-body', html: _docsBundle2.default.listener })
      )];
    }
  }]);
...
;
},{"radi":13,"../../layouts/DocsLayout.radi":50,"../../helpers/docs-bundle.js":51}]},{},[29])
