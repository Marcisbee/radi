(function () {
  ...
  window.treeList = component({
    ...
    view() {
      return r(
        'div',
        list(l(this.array), item => r('div', 'item')),
      );
    },
    props: {
      array: Array,
          ...
          r(
            ...
            cond(
              ...
              r(
                ...
                list(l(component.vars.state), item => r(
                  'li',
                  l(item.key),
                  ': ',
                  cond(l(Array.isArray(item.value) && item.value !== null),
                ...
                list(l(component.vars.props), item => r(
                  'li',
                  l(item.key),
                  ': ',
                  cond(
                ...
                list(l(component.vars.actions), item => r(
                  'li',
                  l(item.key),
                  ': ',
                  r(
