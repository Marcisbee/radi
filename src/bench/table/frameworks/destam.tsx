...
/** @jsx h */
/** @jsxFrag Fragment */
import { h, mount as mount2, OArray, Observer } from "npm:destam-dom";
import { atomic } from "npm:destam/Network";
    ...
    for (let i = 0; i < count; i++) {
      ...
      const dom = (
        <tr class={selector(label)}>
          ...
          <td class="col-md-4">
            <a $clickHandler={select} $textContent={label} />
          </td>
          <td class="col-md-1">
            <a $clickHandler={remove}>
