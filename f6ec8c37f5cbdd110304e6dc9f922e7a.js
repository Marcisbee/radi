...
var Events = function (_radi$Component) {
  _inherits(Events, _radi$Component);
  ...
  function Events() {
    ...
    var _this = _possibleConstructorReturn(this, (_ref = Events.__proto__ || Object.getPrototypeOf(Events)).call.apply(_ref, [this].concat(args)));
  ...
  _createClass(Events, [{
    ...
    value: function view() {
      ...
      return [_radi3.default.r(
        ...
        null,
        _radi3.default.r('div', { 'class': 'wrapper main markdown-body', html: _docsBundle2.default.events })
      )];
    }
  }]);
