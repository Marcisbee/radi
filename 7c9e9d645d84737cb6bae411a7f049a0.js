...
var Plugin = function (_radi$Component) {
  _inherits(Plugin, _radi$Component);
  ...
  function Plugin() {
    ...
    var _this = _possibleConstructorReturn(this, (_ref = Plugin.__proto__ || Object.getPrototypeOf(Plugin)).call.apply(_ref, [this].concat(args)));
  ...
  _createClass(Plugin, [{
    ...
    value: function view() {
      ...
      return [_radi3.default.r(
        ...
        null,
        _radi3.default.r('div', { 'class': 'wrapper main markdown-body', html: _docsBundle2.default.plugin })
      )];
    }
  }]);
...
;
},{"radi":13,"../../layouts/DocsLayout.radi":50,"../../helpers/docs-bundle.js":51}]},{},[32])
