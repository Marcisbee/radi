...
(function(a,d){"object"===typeof exports&&"undefined"!==typeof module?d():"function"===typeof define&&define.amd?define(d):d()})(this,function(){var a=arguments,d={},e=!1,f={},h=function(b,c){for(var p=[],a=1;a<arguments.length;++a)p[a-1]=arguments[a];this.component=b;this.key=$jscomp.makeIterator(p).next().value;this.childPath=p.slice(1,p.length);this.value=null;this.changeListeners=[];this.processValue=function(b){return b};this.component.addListener(this.key,this);this.handleUpdate(this.component[this.key])};
...
return b};var l=function(b){var c=b.listener,a=b.element;this.attributeKey=b.attributeKey;this.listener=c;this.element=a;this.attached=!1;this.handleValueChange=this.handleValueChange.bind(this)};l.prototype.attach=function(){this.element.attributeListeners||(this.element.attributeListeners=[]);this.element.attributeListeners.push(this);this.listener.onValueChange(this.handleValueChange);this.attached=!0;return this};l.prototype.handleValueChange=function(b){var c={};y(this.element,(c[this.attributeKey]=
b,c))};l.prototype.updateElement=function(b){return this.element=b};var m=function(b){var c=b.listener,a=b.element;this.styleKey=b.styleKey;this.listener=c;this.element=a;this.attached=!1;this.handleValueChange=this.handleValueChange.bind(this)};m.prototype.attach=function(){this.element.styleListeners||(this.element.styleListeners=[]);this.element.styleListeners.push(this);this.listener.onValueChange(this.handleValueChange);this.attached=!0;return this};m.prototype.handleValueChange=function(b){x(this.element,
this.styleKey,b)};m.prototype.updateElement=function(b){return this.element=b};var x=function(b,c,a){if("undefined"!==typeof a){if(a instanceof h)return(new m({styleKey:c,listener:a,element:b})).attach(),b[c];b=b.style;a="number"!==typeof a||Number.isNaN(a)?a:a+"px";return b[c]=a}},y=function(b,c){for(var a in c){var g=c[a];if("undefined"!==typeof g)if("style"===a){var d=void 0,e=b;"string"===typeof g&&(e.style=g);if("object"===typeof g&&!Array.isArray(g))if(g instanceof h)(new l({attributeKey:"style",
listener:g,element:e})).attach();else for(d in g)x(e,d,g[d])}else g instanceof h?(new l({attributeKey:a,listener:g,element:b})).attach():"on"===a.substring(0,2).toLowerCase()?b[a]=g:b.setAttribute(a,g)}},q=function(b){if("object"!==typeof b||null===b)return b;if(Array.isArray(b))return b.map(q);var c={},a;for(a in b)b.hasOwnProperty(a)&&(c[a]=q(b[a]));return c},B=function(){for(var b="",c=0;32>c;c++){var a=16*Math.random()|0;if(8===c||12===c||16===c||20===c)b+="-";b+=(12===c?4:16===c?a&3|8:a).toString(16)}return b},
u=function(b){this.component=b;this.html=document.createDocumentFragment();this.node={}};u.prototype.render=function(){var b=this;this.html.appendChild(this.node=this.component.$view);this.html.destroy=this.node.destroy=function(){return b.component.destroy()};return this.html};u.prototype.destroyHtml=function(){var b=this;this.node.childNodes&&this.node.childNodes.forEach(function(c){b.node.removeChild(c)});this.html.childNodes&&this.html.childNodes.forEach(function(c){b.html.removeChild(c)});this.html=
...
typeof this.$mixins[b]};k.prototype.mount=function(){if("function"===typeof this.$actions.onMount)this.$actions.onMount(this);f[this.$id]=this};k.prototype.unmount=function(){if("function"===typeof this.$actions.onDestroy)this.$actions.onDestroy(this);delete f[this.$id]};k.prototype.render=function(){this.mount();return this.$renderer.render()};k.prototype.destroy=function(){this.unmount();return this.$renderer.destroyHtml()};k.isComponent=function(){return!0};var C=function(b){return Array.isArray(b)?
b:[b]},z=function(b){if(b instanceof DocumentFragment)return Array.from(b.childNodes).map(function(b){var a=b;b=a.cloneNode(!0);b.remove();return a});var a=document.createDocumentFragment();v(a,C(b));return z(a)},r=function(b){var a=b.element;this.listener=b.listener;this.element=a;this.listenerAsNode=[];this.attached=!1;this.handleValueChange=this.handleValueChange.bind(this)};r.prototype.attach=function(){this.element.listeners||(this.element.listeners=[]);this.element.listeners.push(this);this.listener.onValueChange(this.handleValueChange);
this.attached=!0;return this};r.prototype.handleValueChange=function(b){b=z(b);for(var a=$jscomp.makeIterator(b),d=a.next();!d.done;d=a.next())d=d.value,this.listenerAsNode[0]?this.element.insertBefore(d,this.listenerAsNode[0]):this.element.appendChild(d);a=$jscomp.makeIterator(this.listenerAsNode);for(d=a.next();!d.done;d=a.next()){d=d.value;for(var g=document.createTreeWalker(d,NodeFilter.SHOW_ELEMENT,function(b){return b&&"function"===typeof b.destroy},!1),e;e=g.nextNode();)e.destroy();d.remove()}this.listenerAsNode=
b};r.prototype.updateElement=function(b){return this.element=b};var w=function(b){return function(a){a||"number"===typeof a||(a="");if(a instanceof k)b.appendChild(a.render());else if(a instanceof h)(new r({listener:a,element:b})).attach();else if(Array.isArray(a))v(b,a);else if("function"===typeof a){var c=document.createElement("div"),d=b.appendChild(c);a().then(function(b){"function"===typeof b.default&&b.default.isComponent&&b.default.isComponent()?w(d)(new b.default):w(d)(b.default)}).catch(function(){})}else a instanceof
Node?b.appendChild(a):b.appendChild(document.createTextNode(a))}},v=function(b,a){a.forEach(w(b))},A=function(b,a){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];return new (Function.prototype.bind.apply(h,[null].concat([b],$jscomp.arrayFromIterable(c))))},D=function(){Object.values(f).forEach(function(b){if("function"===typeof b.onMount)b.onMount(b)})},t={version:"0.2.2",activeComponents:f,r:function(b,a,d){for(var c=[],e=2;e<arguments.length;++e)c[e-2]=arguments[e];if("function"===
typeof b.isComponent&&b.isComponent())return(new b(c)).setProps(a||{});if("function"===typeof b)return e=a||{},e.children=c,b(e);"string"===typeof b?e=document.createElement(b):(console.warn("[Radi.js] Warn: Creating a JSX element whose query is not of type string, automatically converting query to string."),e=document.createElement(b.toString()));null!==a&&y(e,a);v(e,c);return e},listen:A,l:A,component:function(b){var a=function(a){return new k(b,a)};a.isComponent=function(){return!0};return a},
headless:function(b,a){a=new a;a.mount();return d["$".concat(b)]=a},mount:function(a,c){c="string"===typeof c?document.getElementById(c):c;a=a instanceof k?a.render():a;c.appendChild(a);return a},freeze:function(){e=!0},unfreeze:function(){e=!1;D()},plugin:function(b,c){for(var d=[],e=1;e<arguments.length;++e)d[e-1]=arguments[e];console.log(a,t);return b.apply(null,[].concat([t],$jscomp.arrayFromIterable(d)))}};window&&(window.$Radi=t);module.exports=t});
