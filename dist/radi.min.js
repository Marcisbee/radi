...
c,a)};g.render=function(a){void 0===a&&(a=g);return v(a,function(){return c.type.call(g,d)})};g.dom=m(g.render(),a);var b;g.dom&&"function"===typeof g.dom.addEventListener&&(g.on("mount",function(){"string"===typeof g.style&&(b=document.createElement("style"),b.innerHTML=g.style,document.head.appendChild(b))},{passive:!0,once:!0},!1),g.on("destroy",function(){g.dom=null;g.self=null;g.__$events={};b instanceof Node&&document.head.removeChild(b)},{passive:!0,once:!0},!1));g.dom.__radiInstance=g;g.trigger("mount",
g.dom,a);return g.dom}function F(c,a,b){void 0===b&&(b=c.parentNode);var d=Object.assign({},a.props,{children:a.children}),k=c.__radiInstance;return k&&k.self===a.type?r(c,k.render(),b):k.isPrototypeOf(a.type)?(a=D(a,b),b?b.replaceChild(a,c)&&a:a):k.isPrototypeOf(a.type)?null:r(c,a.type(d),b)}function L(a,d){return"function"===typeof a.beforedestroy?a.beforedestroy(d):d()}function r(a,d,b){var c,k;void 0===b&&(b=a.parentNode);var f=b?function(c){return b.replaceChild(c,a)&&c}:function(a){return a};
if("object"===typeof d&&"function"===typeof d.type)return F(a,d,b);if("object"!==typeof d&&a instanceof Text)return a.textContent!==d?f(m(d,b)):a;if("object"===typeof d&&a instanceof Text||"object"===typeof d&&a.nodeName!==d.type.toUpperCase())return f(m(d,b));if("object"===typeof d&&a.nodeName===d.type.toUpperCase()){var p={};f=document.activeElement;(c=[]).concat.apply(c,a.childNodes).filter(function(a){return!a.__radiRemoved}).forEach(function(a,c){p[a.__radiKey||"__index_"+c]=a});(k=[]).concat.apply(k,
d.children).forEach(function(c,d){d=c.props&&(c.props.key||"__index_"+d);if(p[d])e("update",r(p[d],c)),delete p[d];else if(c=p[d]?r(p[d],c):m(c,a))a.appendChild(c),delete p[d]});c=function(a){p[a].__radiRemoved=!0;L(p[a],function(){h(p[a]);p[a].remove()})};for(var u in p)c(u);u=$jscomp.makeIterator(a.attributes);for(c=u.next();!c.done;c=u.next())a.removeAttribute(c.value.name);for(var G in d.props)w(a,G,d.props[G]);f.focus();return a}return null}function E(a,d){return function(c,b){if(a[0]===c)return!1;
c!==b&&(a[0]=c,d.dispatch(function(){return c}));return!0}}function x(a,d){var c=this;void 0===d&&(d=[]);if(!a)return a;if(this&&a&&"function"===typeof a.subscribe){var b=[];0<d.length?a.subscribe(function(a,g){if(b[0]===a)return!1;a!==g&&(c.dispatch(function(){return c.setPartial(d,a)}),b[0]=a);return!0}):(this.subscribe(E(b,a)),a.subscribe(E(b,this)));return a.get()}if("object"===typeof a){var e=Array.isArray(a)?Array(a.length):{},f;for(f in a)a.hasOwnProperty(f)&&(e[f]=x.call(c,a[f],d.concat(f)));
return e}return a}function H(a,d,b){void 0===b&&(b=[]);return new Proxy(a,{get:function(c,k){c=b.concat(k);if("object"===typeof a[k])return H(a[k],d,c);"function"===typeof d&&d(c);return a[k]}})}function M(){var a=this;this.dependencies={};this.add=function(c,b){c=c[0];"undefined"===typeof a.dependencies[c]&&(a.dependencies[c]=[]);0>a.dependencies[c].indexOf(b)&&a.dependencies[c].push(b)};this.remove=function(c,b){c=c[0];b=(a.dependencies[c]||[]).indexOf(b);0<=b&&a.dependencies[c].splice(b,1)};this.fn=
function(c){return function(b){var d=y.currentComponent;d&&(a.add(b,d),d.__onDestroy=function(){a.remove(b,d)});return c(b)}};this.trigger=function(c,b,g){a.dependencies[c]&&a.dependencies[c].forEach(function(a){return(a.update?a.update:a)(b,g)})}}function A(a,b){var c=this;void 0===a&&(a={});void 0===b&&(b=function(){});var d=Object.assign({},a),e=function(){return H(e.get(),f.fn(b))},f=new M,h=function(a){return a};e.getInitial=function(){return u};e.get=function(){return h(d)};e.setPartial=function(a,
b){var g=Array.isArray(d)?[]:{};if(a.length){g[a[0]]=1<a.length?c.setPartial(a.slice(1),b,d[a[0]]):b;a=d;b=Array.isArray(a)?[]:{};for(var e in a)b[e]=a[e];for(var k in g)b[k]=g[k]}return b};e.update=function(a){var c=Object.keys(a),b=d;d=Object.assign({},d,a);f.trigger("*",e.get(),b);c.forEach(function(a){return f.trigger(a,e.get(),b)});return d};e.dispatch=function(a){for(var c=[],b=arguments.length-1;0<b--;)c[b]=arguments[b+1];c=a.apply(void 0,[d].concat(c));return e.update(c)};e.willDispatch=function(a){for(var c=
[],b=arguments.length-1;0<b--;)c[b]=arguments[b+1];return function(){for(var b=[],d=arguments.length;d--;)b[d]=arguments[d];return e.dispatch.apply(e,[a].concat(c,b))}};e.subscribe=function(a){f.add("*",a);a(e.get(),null);return e};e.unsubscribe=function(a){f.remove("*",a)};e.map=function(a){var c=h;h=function(){for(var b=[],d=arguments.length;d--;)b[d]=arguments[d];return a(c.apply(void 0,b))};return e};var u=x.call(e,a);return e}function B(a,b,e){var c=I(a,function(a,c){return{touched:a.touched,
value:c}});a=Object.keys(c).reduce(function(a,b){var d;return Object.assign({},a,(d={},d[b]=c[b].value,d))},{});var d=[],k;for(k in c){var f=c[k];if("function"===typeof b[k]){var h=b[k](f.value,a);h=h&&"function"===typeof h.check&&h.check()||h||k+" field is invalid";!0!==h&&d.push({field:k,touched:!!f.touched,error:h})}}e(d)}var n={VERSION:"0.5.0",CUSTOM_ATTRIBUTES:{},CUSTOM_TAGS:{},SERVICES:{}},N=function(a){return[].reduce.call(a,function(a,c){return c.selected?a.concat(c.value):a},[])},I=function(a,
b){void 0===b&&(b=function(a,c){return c});return[].reduce.call(a,function(a,c){var d;if(d=c.name&&(c.value||""===c.value))d=!["checkbox","radio"].includes(c.type)||c.checked;d&&(a[c.name]="checkbox"===c.type?(a[c.name]||[]).concat(b(c,c.value)):c.options&&c.multiple?b(c,N(c)):b(c,c.value));return a},{})},z=function(a,b){this.self=a;this.name=b||a.name;this.__$events={}};z.prototype.on=function(a,b){var c=this.__$events;a="on"+f(a);c[a]||(c[a]=[]);c[a].push(b);return b};z.prototype.trigger=function(a){for(var c,
b=[],e=arguments.length-1;0<e--;)b[e]=arguments[e+1];e="on"+f(a);(this.__$events[e]||[]).map(function(a){return a.apply(void 0,b)});"function"===typeof this[e]&&this[e].apply(this,b);"function"===typeof this.self[e]&&(c=this.self)[e].apply(c,b)};var y={currentComponent:null},J=function(a,b,e,f){e=e[b];if("function"!==typeof e)console.warn("[Radi.js] Animation `"+b+"` for node `"+a.nodeName.toLowerCase+"` should be function");else return e(a,f)};b("animation",function(a,b){J(a,"in",b,function(){});
a.beforedestroy=function(c){return J(a,"out",b,c)}});b("html",function(a,b){var c=function(){a.escape?a.textContent=b:a.innerHTML=b};a.addEventListener("mount",c);a.addEventListener("update",c)});b("loadfocus",function(a){a.addEventListener("mount",function(){return a.focus()})});b("onsubmit",function(a,b){return function(c){a.prevent&&c.preventDefault();b(c,I(a.elements||{}))}},{allowedTags:["form"],addToElement:!0});var K=new A({},"errorStore"),O=function(a,b,e){var c;return Object.assign({},a,
(c={},c[b]=e,c))},P=0;b("onvalidate",function(a,b){function c(a){K.dispatch(O,d,a)}var d=a.name||"defaultForm"+P++,e;K.subscribe(function(a){e&&(e.disabled=0<a[d].length)});a.addEventListener("mount",function(a){var d=b(a),f=a.target.elements;if(d&&"object"===typeof d&&f){a=$jscomp.makeIterator(f);for(var g=a.next();!g.done;g=a.next()){g=g.value;var k=g.name;if(!g.__radiValidate&&"string"===typeof k&&"function"===typeof d[k]){g.addEventListener("input",function(){B(f,d,c)});g.__radiValidate=!0;g.touched=
!1;var h=function(a){a=a.target;a.touched=!0;a.removeEventListener("change",h);B(f,d,c)};g.addEventListener("change",h)}"submit"===g.type&&!0===g.disabled&&(e=g)}B(f,d,c)}},!1)},{allowedTags:["form"]});var q=function(a){this.value=a;this.rules=[]};q.prototype.register=function(a){var c=this,b=a.validate,e=a.error,f=this.rules.push({type:a.type,validate:function(a){return("string"===typeof a||"number"===typeof a||a)&&b(a)},error:e||"Invalid field"});this.error=function(a){c.rules[f-1].error=a||e;return c};
return this};q.prototype.check=function(a){var c=this;"undefined"!==typeof a&&(this.value=a);return this.rules.reduce(function(a,b){return"string"===typeof a?a:!b.validate(c.value)&&b.error||a},!0)};q.prototype.required=function(){return this.register({type:"required",validate:function(a){return""!==a},error:"Field is required"})};q.prototype.test=function(a){return this.register({type:"test",validate:function(b){return""===b||a.test(b)},error:"Field must be valid"})};q.prototype.equal=function(a){return this.register({type:"equal",
...
q.prototype.email=function(){return this.register({type:"email",validate:function(a){return""===a||/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a)},error:"Email is not valid"})};var C={v:n.VERSION,version:n.VERSION,h:l,html:l,Store:A,customTag:function(a,b){return n.CUSTOM_TAGS[a]={name:a,render:b||function(){}}},customAttribute:b,patch:r,mount:m,service:a,Subscribe:function(a){void 0===a&&(a=document);return{on:function(b,c){function d(b,d){var g=d||new A(b||{});l=!0;h=b;k=g;e.map(function(b){return a.addEventListener(b,
f=function(){for(var a=[],d=arguments.length;d--;)a[d]=arguments[d];return g.dispatch(function(d){return Object.assign({},d,c.apply(void 0,a.concat([b])))})})});return g}void 0===c&&(c=function(a){return a});var e=b.trim().split(" "),f=null,h=null,k=null,l=!1;if("function"!==typeof c)throw Error("[Radi.js] Subscription `"+b+"` must be transformed by function");d.stop=function(){l&&e.map(function(b){return a.removeEventListener(b,f)});return l=!l};d.start=function(){return!l&&d(h,k)};return d}}},Validator:q,
plugin:function(a){for(var b=[],c=arguments.length-1;0<c--;)b[c]=arguments[c+1];return a.apply(void 0,[C].concat(b))}};window&&(window.Radi=C);return C});
