...
var Hyperscript = function (_radi$Component) {
  _inherits(Hyperscript, _radi$Component);

  function Hyperscript() {
    var _ref;

    _classCallCheck(this, Hyperscript);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    var _this = _possibleConstructorReturn(this, (_ref = Hyperscript.__proto__ || Object.getPrototypeOf(Hyperscript)).call.apply(_ref, [this].concat(args)));
  ...
  _createClass(Hyperscript, [{
    ...
    value: function view() {
      ...
      return [_radi3.default.r(
        ...
        null,
        _radi3.default.r('div', { 'class': 'wrapper main markdown-body', html: _docsBundle2.default.hyperscript })
      )];
    }
  }]);
...
;
},{"radi":13,"../../layouts/DocsLayout.radi":50,"../../helpers/docs-bundle.js":51}]},{},[24])
